...
//------ API Laptop data-----
export const getApiDataLaptop = createAsyncThunk('product/getApiDataLaptop', async () => {
...
//------ API CPU data-----
export const getApiDataCPU = createAsyncThunk('product/getApiDataCPU', async () => {
  const res = await axios
...
//------ API Screens data-----
export const getApiDataScreen = createAsyncThunk('product/getApiDataScreen', async () => {
  const res = await axios
